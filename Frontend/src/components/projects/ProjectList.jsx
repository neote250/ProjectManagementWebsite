...
const ProjectList = ({ onSelectProject }) => {
  ...
  const handleCreateProject = () => {
    const newProject = {
      ...
      taskDifficulty: <input name="difficultyInput" type="number" />,
      people: <input name="enterPersonName" />,
      hours: <input name="hours" type="number" />,
      estimatedTime: <input name="estimatedTime" type="number" />,
    };
  ...
  return (
    <div className="p-4">
      {/* Header with (logo) Button & (layout) Toggle */}
      ...
      {/* create and allow users to input into 
